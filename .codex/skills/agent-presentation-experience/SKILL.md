...
description: >
  ...
  Loads these skills on activation: presentation-experience, core-game-vision.
license: World of Goses project license
compatibility: Codex CLI 0.145+ (project-level skills)
metadata:
  agent_id: presentation-experience
  canonical: .agents/agents/presentation-experience/AGENT.md
  read_only: false
---
