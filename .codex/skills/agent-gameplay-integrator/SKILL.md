---
name: agent-gameplay-integrator
description: >
  gameplay-integrator agent for World of Goses.
  ...
  Loads these skills on activation: core-game-vision.
license: World of Goses project license
compatibility: Codex CLI 0.145+ (project-level skills)
metadata:
  agent_id: gameplay-integrator
  canonical: .agents/agents/gameplay-integrator/AGENT.md
  read_only: false
---
# Gameplay integrator
