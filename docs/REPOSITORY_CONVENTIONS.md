...
│   ├── UI_AUDIT.md, UI_PATTERNS.md        # UI state and patterns
│   ├── PERFORMANCE_BUDGETS.md             # frame time and allocations
│   ├── VISUAL_REGRESSION.md               # reproducible visual reviews
