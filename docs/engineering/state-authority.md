...
This is the opening's soft-lock rule expressed as code rather than as intent:
the first guided sortie cannot silently kill or irreversibly trap the city. Regressions
