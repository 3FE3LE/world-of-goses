...
**Cómo está implementado:** schema v25 introdujo filas continuas, ventanas
...
solares. La expansión lateral, el arte por frente y los interiores modulares
quedan descritos aquí como parte del estándar, no como implementación vigente.
...
También conserva los casos de aceptación con los que se juzga cualquier
colocación, expansión o corredor.
...
El estándar deliberadamente no cubre:
...
Lo que el estándar sí sostiene:
