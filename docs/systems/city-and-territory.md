...
### Mundo macro caminable

La vista macro es un mundo caminable con cámara, no un lienzo fijo, con una
perspectiva pseudo-3D por calles (ver
`../presentation/visual-language.md`, "Ciudad macro (perspectiva por
...
de profundidad, distintas del corredor de navegación de 2 tiles descrito en
`frontage-and-corridors.md` (ver la desambiguación en el doc visual). Avanzar/retroceder en
...
"Profundidad y desniveles" en `../presentation/visual-language.md` para la
mecánica visual y `../engineering/architecture.md` §9-§10 para la arquitectura
técnica.
...
[`frontage-and-corridors.md`](frontage-and-corridors.md).
